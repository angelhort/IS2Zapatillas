...
public class GUICliente extends JFrame implements IGUI{
	...
	private void initModificar(TransferCliente datos) {
		...
		JLabel labelCliente = ComponentsBuilder.createLabel("Modificar Cliente", 85, 20, 190, 50, Color.BLACK, new Font("Serif", Font.PLAIN, 22));
		modificar.add(labelCliente);
